        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7">
            ...
            <div className="flex flex-wrap gap-4 opacity-0 animate-fade-in-up" style={{ animationDelay: '600ms', animationFillMode: 'forwards' }}>
              <Button size="lg" className="neo-button rounded-full bg-white text-black hover:bg-white/90">
                <Workflow className="mr-2 h-5 w-5" />
                Explore Our Services
              </Button>
              
              <Button variant="outline" size="lg" className="neo-button rounded-full border-white text-white hover:bg-white/10">
