    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-grow pt-12 pb-12 relative">
        ...
        <div className="container mx-auto max-w-6xl px-4 relative z-10">
          ...
          <div className="mt-16">
            <div id="ai-strategy" className="scroll-mt-32">
              <ServiceDetail
            ...
            <div id="chatbots" className="scroll-mt-32">
              <ServiceDetail
            ...
            <div id="data-insights" className="scroll-mt-32">
              <ServiceDetail
            ...
            <div id="custom-development" className="scroll-mt-32">
              <ServiceDetail
